...
class HistoriesControllerTest < ActionController::TestCase
  ...
  test "should create history" do
    assert_difference('History.count') do
      post :create, history: { box_id: @history.box_id, observacion: @history.observacion, user_id: @history.user_id }
    end
  ...
  test "should update history" do
    patch :update, id: @history, history: { box_id: @history.box_id, observacion: @history.observacion, user_id: @history.user_id }
    assert_redirected_to history_path(assigns(:history))
  end
